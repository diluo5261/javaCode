...
public interface ManagerService extends IService<SpuInfo> {
    ...
    /**
     * 根据一级分类id,获取所有的二级分类信息
     * @return
     */
    List<BaseCategory2> getCategory2(Long category1Id);

    /**
     * 根据二级分类id,获取所有的三级分类信息
     * @return
     */
    ...
    /**
     * 根据skuId查询skuInfo,和skuImageList
     * @param skuId
     * @return
     */
     ...
     * @return
     */
    BaseCategoryView getCategoryViewCateBy3Id(Long category3Id);
    ...
    /**
     * 根据spuId查询map集合属性,根据spuId获取销售属性Id与skuId的组合数据
     * @param skuId
     * @param spuId
     * @return
     */
    List<SpuSaleAttr> selectSaleAttrValuesBySpu(Long skuId, Long spuId);
